...
export interface AccountStore {
   ...
   * Populate {@link InvalidCredentialsError.sub} when the identifier matched
   * an existing account (e.g. wrong password for a known user); omit it when
   * the identifier was not found. Throwing the generic
