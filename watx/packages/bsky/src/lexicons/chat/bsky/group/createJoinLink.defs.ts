...
const main = l.procedure(
  ...
  l.jsonPayload({
    convoId: l.string(),
    requireApproval: l.optional(l.withDefault(l.boolean(), false)),
    joinRule: l.ref<GroupDefs.JoinRule>((() => GroupDefs.joinRule) as any),
  }),
  l.jsonPayload({
    joinLink: l.ref<GroupDefs.JoinLinkView>(
