...
function default_1(server, ctx) {
    server.add(index_js_1.com.atproto.server.createAccount, {
        rateLimit: {
...
const validateInputsForLocalPds = async (ctx, input, requester) => {
    ...
    if (password && password.length > scrypt_1.NEW_PASSWORD_MAX_LENGTH) {
        throw new xrpc_server_1.InvalidRequestError(`Password too long. Maximum length is ${scrypt_1.NEW_PASSWORD_MAX_LENGTH} characters.`);
    }
