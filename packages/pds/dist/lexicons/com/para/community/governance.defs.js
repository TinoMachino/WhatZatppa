...
const main = lex_1.l.record('any', $nsid, lex_1.l.object({
    community: lex_1.l.string({ maxGraphemes: 128, maxLength: 256 }),
    communityId: lex_1.l.optional(lex_1.l.string({ maxGraphemes: 128, maxLength: 256 })),
    slug: lex_1.l.string({ maxGraphemes: 128, maxLength: 128 }),
    ...
    editHistory: lex_1.l.optional(lex_1.l.array(lex_1.l.ref((() => CommunityDefs.historyEntry)))),
}));
exports.main = main;
...
//# sourceMappingURL=governance.defs.js.map