...
const main = lex_1.l.record('tid', $nsid, lex_1.l.object({
    subject: lex_1.l.optional(lex_1.l.string({ format: 'at-uri' })),
    ...
    signal: lex_1.l.optional(lex_1.l.integer({ minimum: -3, maximum: 3 })),
    reason: lex_1.l.optional(lex_1.l.string({ maxLength: 1000 })),
    isDirect: lex_1.l.boolean(),
    delegatedFrom: lex_1.l.optional(lex_1.l.array(lex_1.l.string({ format: 'did' }), { maxLength: 10000 })),
...
//# sourceMappingURL=vote.defs.js.map