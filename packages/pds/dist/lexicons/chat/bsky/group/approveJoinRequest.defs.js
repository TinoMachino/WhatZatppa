...
const main = lex_1.l.procedure($nsid, lex_1.l.params(), lex_1.l.jsonPayload({ convoId: lex_1.l.string(), member: lex_1.l.string({ format: 'did' }) }), lex_1.l.jsonPayload({
...
//# sourceMappingURL=approveJoinRequest.defs.js.map