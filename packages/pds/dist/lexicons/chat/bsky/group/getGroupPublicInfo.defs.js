...
const main = lex_1.l.query($nsid, lex_1.l.params({ code: lex_1.l.string() }), lex_1.l.jsonPayload({
    group: lex_1.l.ref((() => GroupDefs.groupPublicView)),
}), ['InvalidCode']);
exports.main = main;
exports.$lxm = main.nsid, exports.$params = main.parameters, exports.$output = main.output;
//# sourceMappingURL=getGroupPublicInfo.defs.js.map