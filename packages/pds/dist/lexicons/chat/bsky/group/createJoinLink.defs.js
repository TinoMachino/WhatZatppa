...
const GroupDefs = __importStar(require("./defs.defs.js"));
const $nsid = 'chat.bsky.group.createJoinLink';
exports.$nsid = $nsid;
...
const main = lex_1.l.procedure($nsid, lex_1.l.params(), lex_1.l.jsonPayload({
    ...
    requireApproval: lex_1.l.optional(lex_1.l.withDefault(lex_1.l.boolean(), false)),
    joinRule: lex_1.l.ref((() => GroupDefs.joinRule)),
}), lex_1.l.jsonPayload({
    joinLink: lex_1.l.ref((() => GroupDefs.joinLinkView)),
}), ['EnabledJoinLinkAlreadyExists', 'InvalidConvo', 'InsufficientRole']);
exports.main = main;
exports.$lxm = main.nsid, exports.$params = main.parameters, exports.$input = main.input, exports.$output = main.output;
//# sourceMappingURL=createJoinLink.defs.js.map