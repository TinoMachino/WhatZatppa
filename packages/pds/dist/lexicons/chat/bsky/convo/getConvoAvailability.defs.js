...
const main = lex_1.l.query($nsid, lex_1.l.params({
    members: lex_1.l.array(lex_1.l.string({ format: 'did' }), {
        minLength: 1,
        maxLength: 10,
    }),
}), lex_1.l.jsonPayload({
    canChat: lex_1.l.boolean(),
    convo: lex_1.l.optional(lex_1.l.ref((() => ConvoDefs.convoView))),
}));
exports.main = main;
exports.$lxm = main.nsid, exports.$params = main.parameters, exports.$output = main.output;
//# sourceMappingURL=getConvoAvailability.defs.js.map