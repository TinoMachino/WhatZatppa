...
const main = lex_1.l.procedure($nsid, lex_1.l.params(), lex_1.l.jsonPayload({ convoId: lex_1.l.string() }), lex_1.l.jsonPayload({ convoId: lex_1.l.string(), rev: lex_1.l.string() }), ['InvalidConvo', 'OwnerCannotLeave']);
exports.main = main;
exports.$lxm = main.nsid, exports.$params = main.parameters, exports.$input = main.input, exports.$output = main.output;
//# sourceMappingURL=leaveConvo.defs.js.map