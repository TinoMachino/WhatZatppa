...
const main = lex_1.l.record('literal:self', $nsid, lex_1.l.object({
    ...
    pronouns: lex_1.l.optional(lex_1.l.string({ maxGraphemes: 20, maxLength: 200 })),
    ...
    banner: lex_1.l.optional(lex_1.l.blob({ accept: ['image/png', 'image/jpeg'], maxSize: 1000000 })),
    labels: lex_1.l.optional(lex_1.l.typedUnion([lex_1.l.typedRef((() => LabelDefs.selfLabels))], false)),
    joinedViaStarterPack: lex_1.l.optional(lex_1.l.ref((() => RepoStrongRef.main))),
...
//# sourceMappingURL=profile.defs.js.map