...
const $nsid = 'app.bsky.notification.listActivitySubscriptions';
exports.$nsid = $nsid;
...
const main = lex_1.l.query($nsid, lex_1.l.params({
    ...
    cursor: lex_1.l.optional(lex_1.l.string()),
    subscriptions: lex_1.l.array(lex_1.l.ref((() => ActorDefs.profileView))),
}));
exports.main = main;
exports.$lxm = main.nsid, exports.$params = main.parameters, exports.$output = main.output;
//# sourceMappingURL=listActivitySubscriptions.defs.js.map