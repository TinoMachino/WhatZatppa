...
exports.like = exports.$output = exports.$params = exports.$lxm = exports.main = exports.$nsid = void 0;
...
const main = lex_1.l.query($nsid, lex_1.l.params({
    ...
    cid: lex_1.l.optional(lex_1.l.string({ format: 'cid' })),
    cursor: lex_1.l.optional(lex_1.l.string()),
    likes: lex_1.l.array(lex_1.l.ref((() => like))),
}));
exports.main = main;
exports.$lxm = main.nsid, exports.$params = main.parameters, exports.$output = main.output;
const like = lex_1.l.typedObject($nsid, 'like', lex_1.l.object({
    indexedAt: lex_1.l.string({ format: 'datetime' }),
    createdAt: lex_1.l.string({ format: 'datetime' }),
    actor: lex_1.l.ref((() => ActorDefs.profileView)),
}));
exports.like = like;
//# sourceMappingURL=getLikes.defs.js.map