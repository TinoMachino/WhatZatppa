...
const main = lex_1.l.query($nsid, lex_1.l.params({
    ...
    filter: lex_1.l.optional(lex_1.l.withDefault(lex_1.l.string(), 'posts_with_replies')),
    includePins: lex_1.l.optional(lex_1.l.withDefault(lex_1.l.boolean(), false)),
}), lex_1.l.jsonPayload({
    cursor: lex_1.l.optional(lex_1.l.string()),
    feed: lex_1.l.array(lex_1.l.ref((() => FeedDefs.feedViewPost))),
