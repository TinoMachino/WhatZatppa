...
const main = lex_1.l.procedure($nsid, lex_1.l.params(), lex_1.l.jsonPayload({
    feed: lex_1.l.optional(lex_1.l.string({ format: 'at-uri' })),
    interactions: lex_1.l.array(lex_1.l.ref((() => FeedDefs.interaction))),
}), lex_1.l.jsonPayload({}));
exports.main = main;
exports.$lxm = main.nsid, exports.$params = main.parameters, exports.$input = main.input, exports.$output = main.output;
//# sourceMappingURL=sendInteractions.defs.js.map