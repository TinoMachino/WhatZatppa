...
const BookmarkDefs = __importStar(require("./defs.defs.js"));
...
const main = lex_1.l.query($nsid, lex_1.l.params({
    ...
    cursor: lex_1.l.optional(lex_1.l.string()),
    bookmarks: lex_1.l.array(lex_1.l.ref((() => BookmarkDefs.bookmarkView))),
}));
exports.main = main;
exports.$lxm = main.nsid, exports.$params = main.parameters, exports.$output = main.output;
//# sourceMappingURL=getBookmarks.defs.js.map