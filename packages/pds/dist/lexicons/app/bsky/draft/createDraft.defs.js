...
const DraftDefs = __importStar(require("./defs.defs.js"));
...
const main = lex_1.l.procedure($nsid, lex_1.l.params(), lex_1.l.jsonPayload({
    draft: lex_1.l.ref((() => DraftDefs.draft)),
}), lex_1.l.jsonPayload({ id: lex_1.l.string() }), ['DraftLimitReached']);
exports.main = main;
exports.$lxm = main.nsid, exports.$params = main.parameters, exports.$input = main.input, exports.$output = main.output;
//# sourceMappingURL=createDraft.defs.js.map