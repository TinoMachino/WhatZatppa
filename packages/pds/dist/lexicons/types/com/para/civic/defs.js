...
exports.isPolicySignalBucket = isPolicySignalBucket;
exports.validatePolicySignalBucket = validatePolicySignalBucket;
exports.isPolicyTally = isPolicyTally;
exports.validatePolicyTally = validatePolicyTally;
...
function isPolicySignalBucket(v) {
    return is$typed(v, id, hashPolicySignalBucket);
}
function validatePolicySignalBucket(v) {
    return validate(v, id, hashPolicySignalBucket);
}
const hashPolicyTally = 'policyTally';
function isPolicyTally(v) {
    return is$typed(v, id, hashPolicyTally);
}
function validatePolicyTally(v) {
    return validate(v, id, hashPolicyTally);
}
