...
function readEnv() {
    return {
        ...
        maxImportSize: (0, common_1.envInt)('PDS_MAX_REPO_IMPORT_SIZE'),
        ...
        // OAuth
        trustedOAuthClients: (0, common_1.envList)('PDS_OAUTH_TRUSTED_CLIENTS'),
        // branding
        ...
        errorColorContrast: (0, common_1.envStr)('PDS_ERROR_COLOR_CONTRAST'),
        errorColorHue: (0, common_1.envInt)('PDS_ERROR_COLOR_HUE'),
        ...
        paraCommunityCreatorDids: (0, common_1.envList)('PDS_PARA_COMMUNITY_CREATOR_DIDS'),
        // mod service
