...
export declare function isProfileAssociatedGerm<V>(v: V): v is import("../../../../util").$TypedObject<V, "app.bsky.actor.defs", "profileAssociatedGerm">;
export declare function validateProfileAssociatedGerm<V>(v: V): ValidationResult<ProfileAssociatedGerm & V>;
...
export declare function isLiveEventPreferences<V>(v: V): v is import("../../../../util").$TypedObject<V, "app.bsky.actor.defs", "liveEventPreferences">;
export declare function validateLiveEventPreferences<V>(v: V): ValidationResult<LiveEventPreferences & V>;
