...
exports.commitEvt = zod_1.z.object({
    ...
    repo: zod_1.z.string().refine(lex_1.isDidString),
...
exports.syncEvt = zod_1.z.object({
    did: zod_1.z.string().refine(lex_1.isDidString),
    blocks: common_1.schema.bytes,
    rev: zod_1.z.string(),
});
exports.identityEvt = zod_1.z.object({
    did: zod_1.z.string().refine(lex_1.isDidString),
    handle: zod_1.z.string().refine(lex_1.isHandleString).optional(),
});
