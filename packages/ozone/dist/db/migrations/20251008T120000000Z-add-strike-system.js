...
async function up(db) {
    ...
    await db.schema
        ...
        .addColumn('activeStrikeCount', 'integer', (col) => col.notNull().defaultTo(0))
        .addColumn('totalStrikeCount', 'integer', (col) => col.notNull().defaultTo(0))
        .execute();
    await db.schema
...
//# sourceMappingURL=20251008T120000000Z-add-strike-system.js.map