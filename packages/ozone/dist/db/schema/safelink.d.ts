...
import { SafelinkActionType, SafelinkEventType, SafelinkPatternType, SafelinkReasonType } from '../../api/util';
export declare const safelinkRuleTableName = "safelink_rule";
export declare const safelinkEventTableName = "safelink_event";
