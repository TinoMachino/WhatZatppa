...
exports.LANGUAGES_MAP_CODE3 = exports.LANGUAGES = void 0;
exports.code3ToCode2 = code3ToCode2;
exports.LANGUAGES = [
...
exports.LANGUAGES_MAP_CODE3 = Object.fromEntries(exports.LANGUAGES.map((lang) => [lang.code3, lang]));
function code3ToCode2(lang) {
    if (lang.length === 3) {
        return exports.LANGUAGES_MAP_CODE3[lang]?.code2 || lang;
    }
    return lang;
}
