...
export declare const isDeviceStore: <V extends Partial<DeviceStore>>(value: V) => value is V & import("../lib/util/type.js").RequiredDefined<DeviceStore>;
export declare function asDeviceStore<V>(implementation: V): V & DeviceStore;
