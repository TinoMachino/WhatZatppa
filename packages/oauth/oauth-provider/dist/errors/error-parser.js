...
function buildErrorPayload(error) {
    ...
    if (error instanceof zod_1.ZodError) {
        return {
            ...
            error_description: (0, zod_error_js_1.formatZodError)(error, 'Validation error'),
        };
    }
    if (error instanceof JOSEError) {
        return {
