...
export declare function parseHttpRequest<A extends readonly KnownNames[]>(req: IncomingMessage, allow: A): Promise<ParserResult<Extract<{
    ...
    readonly parse: (buffer: Buffer<ArrayBufferLike>, { charset }: import("./parser.js").ContentType) => { [_ in string]?: string; };
}, {
    name: A[number];
}> | Extract<{
    readonly name: "bytes";
...
export declare function flushStream(stream: AsyncIterable<any>): Promise<void>;
