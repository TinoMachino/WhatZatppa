...
export declare const parsers: [{
    ...
    readonly parse: (buffer: Buffer<ArrayBufferLike>, { charset }: ContentType) => Json;
}, {
    readonly name: "urlencoded";
    readonly test: (mime: string) => mime is "application/x-www-form-urlencoded";
    readonly parse: (buffer: Buffer<ArrayBufferLike>, { charset }: ContentType) => { [_ in string]?: string; };
}, {
    readonly name: "bytes";
    readonly test: (mime: string) => mime is "application/octet-stream";
    readonly parse: (buffer: Buffer<ArrayBufferLike>) => Buffer;
}];
