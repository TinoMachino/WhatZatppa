...
export declare function buildSecurityHeaders({ csp, coep, corp, coop, hsts, }: SecurityHeadersOptions): Generator<[string, string], void, unknown>;
export declare function setSecurityHeaders(res: ServerResponse, options: SecurityHeadersOptions): void;
