...
declare const $nsid = "app.bsky.feed.repost";
export { $nsid };
...
export type { Main };
/** Record representing a 'repost' of an existing Bluesky post. */
declare const main: l.RecordSchema<"tid", "app.bsky.feed.repost", l.Validator<Omit<Main, "$type">, Omit<Main, "$type">>>;
export { main };
export declare const $isTypeOf: <TValue extends {
    $type?: unknown;
}>(value: TValue) => value is l.TypedRecord<"app.bsky.feed.repost", TValue>, $build: {
...
//# sourceMappingURL=repost.defs.d.ts.map