...
const $nsid = 'app.bsky.draft.deleteDraft';
exports.$nsid = $nsid;
/** Deletes a draft by ID. Requires authentication. */
const main = lex_1.l.procedure($nsid, lex_1.l.params(), lex_1.l.jsonPayload({ id: lex_1.l.string({ format: 'tid' }) }), lex_1.l.payload());
exports.main = main;
exports.$lxm = main.nsid, exports.$params = main.parameters, exports.$input = main.input, exports.$output = main.output;
//# sourceMappingURL=deleteDraft.defs.js.map