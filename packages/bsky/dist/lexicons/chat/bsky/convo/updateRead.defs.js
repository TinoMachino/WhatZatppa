...
const main = lex_1.l.procedure($nsid, lex_1.l.params(), lex_1.l.jsonPayload({ convoId: lex_1.l.string(), messageId: lex_1.l.optional(lex_1.l.string()) }), lex_1.l.jsonPayload({
...
//# sourceMappingURL=updateRead.defs.js.map