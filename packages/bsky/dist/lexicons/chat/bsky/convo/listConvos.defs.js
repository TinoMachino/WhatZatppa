...
const main = lex_1.l.query($nsid, lex_1.l.params({
    ...
    readState: lex_1.l.optional(lex_1.l.string()),
    status: lex_1.l.optional(lex_1.l.string()),
    kind: lex_1.l.optional(lex_1.l.string()),
}), lex_1.l.jsonPayload({
    cursor: lex_1.l.optional(lex_1.l.string()),
    convos: lex_1.l.array(lex_1.l.ref((() => ConvoDefs.convoView))),
}));
exports.main = main;
exports.$lxm = main.nsid, exports.$params = main.parameters, exports.$output = main.output;
//# sourceMappingURL=listConvos.defs.js.map