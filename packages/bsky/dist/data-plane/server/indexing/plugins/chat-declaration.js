...
const makePlugin = (db, background) => {
    const processor = new processor_1.RecordProcessor(db, background, {
        schema: lexicons_1.chat.bsky.actor.declaration.main,
        insertFn,
        findDuplicate,
        deleteFn,
        notifsForInsert,
...
//# sourceMappingURL=chat-declaration.js.map