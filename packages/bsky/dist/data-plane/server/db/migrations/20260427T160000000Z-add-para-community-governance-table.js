...
async function up(db) {
    await db.schema
        ...
        .addColumn('matterFlairIds', (0, kysely_1.sql) `jsonb`)
        .addColumn('policyFlairIds', (0, kysely_1.sql) `jsonb`)
...
//# sourceMappingURL=20260427T160000000Z-add-para-community-governance-table.js.map