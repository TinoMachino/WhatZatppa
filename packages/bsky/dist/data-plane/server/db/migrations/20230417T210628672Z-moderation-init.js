...
async function up(db) {
    ...
    await db.schema
        ...
        .addColumn('actionId', 'integer', (col) => col.notNull().references('moderation_action.id'))
    ...
    await db.schema
        ...
        .addColumn('reportId', 'integer', (col) => col.notNull().references('moderation_report.id'))
        .addColumn('actionId', 'integer', (col) => col.notNull().references('moderation_action.id'))
        .addColumn('createdBy', 'varchar', (col) => col.notNull())
        .addColumn('createdAt', 'varchar', (col) => col.notNull())
...
//# sourceMappingURL=20230417T210628672Z-moderation-init.js.map