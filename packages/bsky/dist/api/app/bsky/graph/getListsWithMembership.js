...
function default_1(server, ctx) {
    const getListsWithMembership = (0, pipeline_1.createPipeline)(skeleton, hydration, filterPurposes, presentation);
    server.add(index_js_1.app.bsky.graph.getListsWithMembership, {
        ...
        handler: async ({ params, auth, req }) => {
            ...
            const result = await getListsWithMembership({ ...params, hydrateCtx }, ctx);
            return {
...
const hydration = async (input) => {
    ...
    return ctx.hydrator.hydrateListsMembership(listUris, actorDid, params.hydrateCtx);
};
...
const presentation = (input) => {
    ...
    const listsWithMembership = (0, common_1.mapDefined)(listUris, (uri) => {
