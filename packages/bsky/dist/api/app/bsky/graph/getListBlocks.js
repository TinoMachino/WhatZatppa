...
function default_1(server, ctx) {
    const getListBlocks = (0, pipeline_1.createPipeline)(skeleton, hydration, pipeline_1.noRules, presentation);
    server.add(index_js_1.app.bsky.graph.getListBlocks, {
...
const skeleton = async (input) => {
    ...
    const { listUris, cursor } = await ctx.hydrator.dataplane.getBlocklistSubscriptions({
