...
function default_1(server, ctx) {
    const getOnboardingSuggestedStarterPacks = (0, pipeline_1.createPipeline)(skeleton, hydration, noBlocks, presentation);
    server.add(index_js_1.app.bsky.unspecced.getOnboardingSuggestedStarterPacks, {
...
const skeleton = async (input) => {
    ...
    const skeleton = await ctx.topicsClient.call(index_js_1.app.bsky.unspecced.getOnboardingSuggestedStarterPacksSkeleton, { limit: params.limit, viewer: params.hydrateCtx.viewer ?? undefined }, { headers: params.headers });
...
//# sourceMappingURL=getOnboardingSuggestedStarterPacks.js.map