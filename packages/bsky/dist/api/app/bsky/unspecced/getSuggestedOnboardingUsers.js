...
function default_1(server, ctx) {
    const getSuggestedOnboardingUsers = (0, pipeline_1.createPipeline)(skeleton, hydration, noBlocksOrFollows, presentation);
    server.add(lexicons_1.app.bsky.unspecced.getSuggestedOnboardingUsers, {
...
const skeleton = async (input) => {
    ...
    return ctx.suggestionsClient.call(lexicons_1.app.bsky.unspecced.getOnboardingSuggestedUsersSkeleton, {
        limit: params.limit,
