...
exports.normalizeUserContext = normalizeUserContext;
exports.mergeUserContexts = mergeUserContexts;
exports.extractUserContextFromGrowthbookUserContext = extractUserContextFromGrowthbookUserContext;
...
function normalizeUserContext(userContext) {
    ...
    if (!deviceId) {
         ...
         * random deviceId.
         */
        deviceId = did ?? `anon-${node_crypto_1.default.randomUUID()}`;
    }
    if (!sessionId) {
        /*
 ...
 */
function mergeUserContexts(base, overrides) {
 ...
 */
function extractUserContextFromGrowthbookUserContext(userContext) {
    /*
 ...
 */
function parsedUserContextToTrackingMetadata(userContext) {
    return {
        base: {
