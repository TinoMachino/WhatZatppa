...
import { type LexArray, type LexBlob, type LexBytes, type LexCidLink, type LexIpldType, type LexPrimitive, type LexToken, Lexicons } from '@atproto/lexicon';
interface Commentable {
    addJsDoc: ({ description }: {
        description: string;
    }) => JSDoc;
}
export declare function genComment<T extends Commentable>(commentable: T, def: {
    description?: string;
}): T;
