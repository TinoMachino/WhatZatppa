...
exports.default = async (sc) => {
    ...
    const mirrorToBsky = async (agent, text) => {
        await agent.app.bsky.feed.post.create({ repo: agent.assertDid }, { text, createdAt: createdAt() });
    };
...
//# sourceMappingURL=para-flairs.js.map