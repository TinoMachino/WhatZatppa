...
export class ComParaActorNS {
  ...
  ): Promise<ComParaActorGetProfileStats.Response> {
    return this._client
...
export class ComParaCivicNS {
  ...
  listDelegationCandidates(
    params?: ComParaCivicListDelegationCandidates.QueryParams,
    opts?: ComParaCivicListDelegationCandidates.CallOptions,
  ): Promise<ComParaCivicListDelegationCandidates.Response> {
    return this._client.call(
  ...
  putLivePresence(
    data?: ComParaCivicPutLivePresence.InputSchema,
    opts?: ComParaCivicPutLivePresence.CallOptions,
  ): Promise<ComParaCivicPutLivePresence.Response> {
    return this._client
...
export class ComParaCivicCabildeoRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCivicCabildeo.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    params: OmitKey<ComAtprotoRepoGetRecord.QueryParams, 'collection'>,
  ): Promise<{ uri: string; cid: string; value: ComParaCivicCabildeo.Record }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.civic.cabildeo',
      ...params,
    })
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCivicCabildeo.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.civic.cabildeo', ...params },
      { headers },
    )
  }
}

export class ComParaCivicDelegationRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCivicDelegation.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCivicDelegation.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.civic.delegation', ...params },
      { headers },
    )
  }
}

export class ComParaCivicPositionRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCivicPosition.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    params: OmitKey<ComAtprotoRepoGetRecord.QueryParams, 'collection'>,
  ): Promise<{ uri: string; cid: string; value: ComParaCivicPosition.Record }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.civic.position',
      ...params,
    })
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCivicPosition.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.civic.position', ...params },
      { headers },
    )
  }
}

export class ComParaCivicVoteRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCivicVote.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async get(
    params: OmitKey<ComAtprotoRepoGetRecord.QueryParams, 'collection'>,
  ): Promise<{ uri: string; cid: string; value: ComParaCivicVote.Record }> {
    const res = await this._client.call('com.atproto.repo.getRecord', {
      collection: 'com.para.civic.vote',
      ...params,
    })
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCivicVote.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.civic.vote', ...params },
      { headers },
    )
  }
}
...
export class ComParaCommunityNS {
  ...
  acceptDraftInvite(
    data?: ComParaCommunityAcceptDraftInvite.InputSchema,
    opts?: ComParaCommunityAcceptDraftInvite.CallOptions,
  ): Promise<ComParaCommunityAcceptDraftInvite.Response> {
    return this._client.call(
  ...
  createBoard(
    data?: ComParaCommunityCreateBoard.InputSchema,
    opts?: ComParaCommunityCreateBoard.CallOptions,
  ): Promise<ComParaCommunityCreateBoard.Response> {
    return this._client.call(
  ...
  getBoard(
    params?: ComParaCommunityGetBoard.QueryParams,
    opts?: ComParaCommunityGetBoard.CallOptions,
  ...
  getGovernance(
    params?: ComParaCommunityGetGovernance.QueryParams,
    opts?: ComParaCommunityGetGovernance.CallOptions,
  ): Promise<ComParaCommunityGetGovernance.Response> {
    return this._client.call(
  ...
  listBoards(
    params?: ComParaCommunityListBoards.QueryParams,
    opts?: ComParaCommunityListBoards.CallOptions,
  ...
  listMembers(
    params?: ComParaCommunityListMembers.QueryParams,
    opts?: ComParaCommunityListMembers.CallOptions,
...
export class ComParaCommunityBoardRecord {
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunityBoard.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunityBoard.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
...
export class ComParaCommunityGovernanceRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunityGovernance.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunityGovernance.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.community.governance', ...params },
      { headers },
    )
  }
}

export class ComParaCommunityMembershipRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaCommunityMembership.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaCommunityMembership.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
  ...
  async delete(
    ...
    await this._client.call(
      'com.atproto.repo.deleteRecord',
      undefined,
      { collection: 'com.para.community.membership', ...params },
      { headers },
    )
  }
}
...
export class ComParaDiscourseNS {
  ...
  getSentiment(
    params?: ComParaDiscourseGetSentiment.QueryParams,
    opts?: ComParaDiscourseGetSentiment.CallOptions,
  ): Promise<ComParaDiscourseGetSentiment.Response> {
    return this._client.call(
  ...
  getSnapshot(
    params?: ComParaDiscourseGetSnapshot.QueryParams,
    opts?: ComParaDiscourseGetSnapshot.CallOptions,
  ): Promise<ComParaDiscourseGetSnapshot.Response> {
    return this._client.call(
  ...
  getTopics(
    params?: ComParaDiscourseGetTopics.QueryParams,
    opts?: ComParaDiscourseGetTopics.CallOptions,
  ): Promise<ComParaDiscourseGetTopics.Response> {
    return this._client.call(
...
export class ComParaFeedNS {
  ...
  getPostThread(
    params?: ComParaFeedGetPostThread.QueryParams,
    opts?: ComParaFeedGetPostThread.CallOptions,
  ): Promise<ComParaFeedGetPostThread.Response> {
    return this._client
  ...
  getPosts(
    params?: ComParaFeedGetPosts.QueryParams,
    opts?: ComParaFeedGetPosts.CallOptions,
  ): Promise<ComParaFeedGetPosts.Response> {
    return this._client.call('com.para.feed.getPosts', params, undefined, opts)
  }

  getTimeline(
    params?: ComParaFeedGetTimeline.QueryParams,
    opts?: ComParaFeedGetTimeline.CallOptions,
...
export class ComParaSocialNS {
  ...
  getPostMeta(
    params?: ComParaSocialGetPostMeta.QueryParams,
    opts?: ComParaSocialGetPostMeta.CallOptions,
  ): Promise<ComParaSocialGetPostMeta.Response> {
    return this._client
...
export class ComParaSocialPostMetaRecord {
  _client: XrpcClient
  ...
  async list(
    ...
    cursor?: string
    records: { uri: string; value: ComParaSocialPostMeta.Record }[]
  }> {
    const res = await this._client.call('com.atproto.repo.listRecords', {
  ...
  async create(
    params: OmitKey<
      ...
      'collection' | 'record'
    >,
    record: Un$Typed<ComParaSocialPostMeta.Record>,
    headers?: Record<string, string>,
  ): Promise<{ uri: string; cid: string }> {
