...
const json_stringify_deep_js_1 = require("./json-stringify-deep.js");
const lex_to_json_js_1 = require("./lex-to-json.js");
/**
 * @internal
 *
 ...
 *
 */
const JSON_STRINGIFY_DEEP_OPTIONS = {
 ...
 * nested structures.
 */
function lexStringify(input, options) {
    const json = (0, lex_to_json_js_1.lexToJson)(input, options);
    try {
        ...
        if (err instanceof RangeError) {
            return (0, json_stringify_deep_js_1.jsonStringifyDeep)(json, JSON_STRINGIFY_DEEP_OPTIONS);
        }
        throw err;
    }
}
//# sourceMappingURL=lex-stringify.js.map