...
exports.lexParseSafe = lexParseSafe;
exports.lexParseJsonBytes = lexParseJsonBytes;
const lex_data_1 = require("@atproto/lex-data");
const json_to_lex_js_1 = require("./json-to-lex.js");
/**
 ...
 * ```
 */
function lexParse(input, options) {
    ...
    return (0, json_to_lex_js_1.jsonToLex)(JSON.parse(input), options);
}
/**
 ...
 * @see {@link jsonToLex} for details and options.
 */
function lexParseSafe(input, options) {
    try {
        return lexParse(input, options);
    }
    catch (err) {
        return undefined;
    }
...
//# sourceMappingURL=lex-parse.js.map