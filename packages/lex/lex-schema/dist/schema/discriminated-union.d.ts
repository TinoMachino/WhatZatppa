import { InferInput, InferOutput, Schema, ValidationContext, ValidationResult, Validator } from '../core.js';
...
type DiscriminatedUnionSchemaInput<TVariants extends readonly Validator[]> = TVariants extends readonly [
    infer TValidator extends Validator,
    ...infer TRest extends readonly Validator[]
] ? InferInput<TValidator> | DiscriminatedUnionSchemaInput<TRest> : never;
type DiscriminatedUnionSchemaOutput<TVariants extends readonly Validator[]> = TVariants extends readonly [
    infer TValidator extends Validator,
    ...infer TRest extends readonly Validator[]
