...
function ProfileScreenLoaded({
  ...
  // New Visibility Tabs
  const showVotesTab = isMe || votesPublic // For non-me users, we would need to check their profile metadata
  const showRaqTab = isMe || raqPublic
  const showHighlightsTab = isMe || highlightsPublic
